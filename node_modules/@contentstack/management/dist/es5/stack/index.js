...
function Stack(http, data) {
  ...
  if (data && data.stack && data.stack.api_key) {
    ...
    this.updateUsersRoles = /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator3["default"])( /*#__PURE__*/_regenerator2["default"].mark(function _callee2(users) {
        var response;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                return _context2.abrupt("return", (0, _index.UserCollection)(http, response.data.stack));
